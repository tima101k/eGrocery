        ...
        <div class="container">
            <div class="grid grid-cols-2" style="align-items: center;">
                <div>
                    ...
                    <p style="font-size: 1.25rem; margin-bottom: 2rem;">Get fresh, high-quality groceries delivered straight to your doorstep. Shop from our wide selection of products at great prices.</p>
                    <a href="products.html" class="btn" style="background: white; color: var(--primary);">Shop Now</a>
                </div>
                <div>
